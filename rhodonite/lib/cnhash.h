...
/*
    Changes applied from the original:
    - Added cnhash_strdel_noval, which won't free() the value of a key.
    - Added #pragma once.
*/
...
void     cnhash_strdel_noval( void * key, void * data, void * opaque );
...
// Modified strdel function that will free the key
// without deleting the value.
void     cnhash_strdel_noval( void * key, void * data, void * opaque )
{
        if( key )  free( key );
}
